...
{
    // Title
    stateElementList.push_back(new Panel(this->stateManager, 250, 116, 700, 250, "Choose Data Structure", 52, sf::Color(0, 0, 0, 0), 0));
    stateElementList.push_back(new Panel(this->stateManager, 250, 116, 700, 250, "", 52, sf::Color(0, 0, 0, 0), 0)); // Removing this will cause a segmentation fault

    // Buttons
    stateElementList.push_back(new Button(this->stateManager, 425, 430, 350, 50, "Array", Action::Array));
    stateElementList.push_back(new Button(this->stateManager, 425, 490, 350, 50, "Grid", Action::Grid));
    stateElementList.push_back(new Button(this->stateManager, 425, 550, 350, 50, "Back", Action::ChangeToMainMenu));
