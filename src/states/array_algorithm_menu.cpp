...
ArrayAlgorithmMenu::ArrayAlgorithmMenu(StateManager *applicationStateManager) : State(applicationStateManager)
{
    ...
    // Buttons
    stateElementList.push_back(new Button(this->stateManager, 425, 430, 350, 50, "Insertion Sort", ActionType::ChangeToArrayMenu, ActionParameter::Null));
    stateElementList.push_back(new Button(this->stateManager, 425, 490, 350, 50, "Selection Sort", ActionType::ChangeToArrayMenu, ActionParameter::Null));
    stateElementList.push_back(new Button(this->stateManager, 425, 550, 350, 50, "Bubble Sort", ActionType::ChangeToArrayMenu, ActionParameter::Null));
